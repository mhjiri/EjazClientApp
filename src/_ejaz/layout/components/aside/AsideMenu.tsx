...
const AsideMenu: React.FC<Props> = ({asideMenuCSSClasses}) => {
  ...
  return (
    ...
    >
      <div
        className='menu menu-column menu-title-gray-700 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500 fw-bold w-5'
        id='#kt_aside_menu'
        data-kt-menu='true'
      >
        <AsideMenuMain />
