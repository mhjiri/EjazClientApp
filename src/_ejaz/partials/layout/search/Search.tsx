            ...
            <div ref={suggestionsElement} className='mb-4' data-kt-search-element='main'>
              <div className='scroll-y mh-200px mh-lg-325px'>
                <div className='d-flex align-items-center mb-5'>
                  <div className='symbol symbol-40px me-4'>
                    <span className='symbol-label bg-light'>
                      <KTIcon iconName='basket' className='fs-2 text-primary' />
                    </span>
                  </div>
                  ...
                  <div className='d-flex flex-column'>
                    ...
                    <span className='fs-7 text-muted fw-bold'>Jameela Safi</span>
                  </div>
                </div>
                ...
                <div className='d-flex align-items-center mb-5'>
                  ...
                  <div className='d-flex flex-column'>
                    ...
                    <span className='fs-7 text-muted fw-bold'>Customer - Subscribed</span>
                  </div>
                </div>
                ...
                <div className='d-flex align-items-center mb-5'>
                  ...
                  <div className='d-flex flex-column'>
                    ...
                    <span className='fs-7 text-muted fw-bold'>Category</span>
                  </div>
                </div>
                ...
                <div className='d-flex align-items-center mb-5'>
                  <div className='symbol symbol-40px me-4'>
                    <span className='symbol-label bg-light'>
                      <KTIcon iconName='paintbucket' className='fs-2 text-primary' />
                    </span>
                  </div>
                  ...
                  <div className='d-flex flex-column'>
                    ...
                    <span className='fs-7 text-muted fw-bold'>Thematic Area</span>
                  </div>
                </div>
                ...
                <div className='d-flex align-items-center mb-5'>
                  <div className='symbol symbol-40px me-4'>
                    <span className='symbol-label bg-light'>
                      <KTIcon iconName='book' className='fs-2 text-primary' />
                    </span>
                  </div>
                  ...
                  <div className='d-flex flex-column'>
                    ...
                    <span className='fs-7 text-muted fw-bold'>Publisher</span>
                  </div>
                </div>
              </div>
            </div>
